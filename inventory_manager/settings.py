...
MIDDLEWARE = [
    ...
    'inventory_app.middlewares.LoginRequiredMiddleware',
]
...
# cron na spousteni import_xml kazdy den v 0200
# na ostrem serveru spustit: python manage.py crontab add
CRONJOBS = [
    ('0 2 * * *', 'inventory_app.management.commands.import_xml.Command')
]
